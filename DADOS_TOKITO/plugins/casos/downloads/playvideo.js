...
const pesquisa = q.trim(), contextInfo = { ...newsletter, mentionedJid: [sender] }
...
const thumbnail = res?.image || res?.thumbnail || null
...
image: { url: thumbnail }, caption: texto, contextInfo
}, { quoted: selo })
} else {
await tokito.sendMessage(from, {
