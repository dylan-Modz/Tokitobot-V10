...
categoria: "ia",
info: {
"descricao": "Executa o comando gemini.",
"uso": "gemini",
"categoria": "ia"
},
async executar(ctx) {
...
const apiUrl = `${API_URL}/api/gemini?texto=${encodeURIComponent(q.trim())}&apikey=${encodeURIComponent(API_KEY_TOKITO)}`
...
console.log('[GEMINI ERRO]', modulos.sanitizarErro(error, [API_KEY_TOKITO]))
