...
> *『 𝙿𝚁𝙾𝙲𝙴𝚂𝚂𝙰𝙽𝙳𝙾 』— ᴇsᴛᴏᴜ ᴘʀᴏᴄᴇssᴀɴᴅᴏ ᴏ sᴇᴜ ᴘᴇᴅɪᴅᴏ, ᴀɢᴜᴀʀᴅᴇ ᴜᴍ ᴘᴏᴜǫᴜɪɴʜᴏ. 🙇‍♂️*`,

  `- 📤 \`𝙴𝙽𝚅𝙸𝙰𝙽𝙳𝙾...\`

> *『 𝙴𝙽𝚅𝙸𝙾 』— ᴊᴀ́ ᴇsᴛᴏᴜ ᴘʀᴇᴘᴀʀᴀɴᴅᴏ ᴛᴜᴅᴏ ᴘʀᴀ ᴠᴏᴄᴇ̂, ᴀɢᴜᴀʀᴅᴀ ᴀɪ́. 📦*`,

  `- 🚀 \`𝙹𝙰́ 𝙴𝚂𝚃𝙰́ 𝙸𝙽𝙳𝙾\`

> *『 𝙴𝙽𝚅𝙸𝙰𝙽𝙳𝙾 』— ᴄᴀʟᴍᴀ ᴀɪ́ ǫᴜᴇ ᴇᴜ ᴊᴀ́ ᴛᴏ̂ ᴄᴏᴍ ᴏ sᴇᴜ ᴘᴇᴅɪᴅᴏ ɴᴀ ᴍᴀ̃ᴏ. 😎*`,

  `- 📦 \`𝙿𝚁𝙴𝙿𝙰𝚁𝙰𝙽𝙳𝙾 𝙾 𝙴𝙽𝚅𝙸𝙾\`

> *『 𝙰𝙶𝚄𝙰𝚁𝙳𝙴 』— ᴏ sᴇᴜ ᴘᴇᴅɪᴅᴏ ᴇsᴛᴀ́ sᴇɴᴅᴏ ᴘʀᴇᴘᴀʀᴀᴅᴏ. 📤*`,

  `- ⚡ \`𝚂𝙾́ 𝚄𝙼 𝙸𝙽𝚂𝚃𝙰𝙽𝚃𝙴\`

> *『 𝙲𝙰𝚁𝚁𝙴𝙶𝙰𝙽𝙳𝙾 』— ᴇᴜ sᴏᴜ ʀᴀ́ᴘɪᴅᴏ, ᴍᴀs ɴᴀ̃ᴏ ғᴀᴄ̧ᴏ ᴍɪʟᴀɢʀᴇ ᴛᴀᴍʙᴇ́ᴍ ɴᴇ́. 😂*`,

  `- 🎯 \`𝙿𝙴𝙳𝙸𝙳𝙾 𝚁𝙴𝙲𝙴𝙱𝙸𝙳𝙾\`

> *『 𝙿𝚁𝙾𝙽𝚃𝙸𝙽𝙷𝙾 』— ᴊᴀ́ ᴇɴᴛᴇɴᴅɪ ᴏ ǫᴜᴇ ᴠᴏᴄᴇ̂ ǫᴜᴇʀ, ᴀɢᴏʀᴀ ᴅᴇɪxᴀ ᴄᴏᴍɪɢᴏ. 😌*`,

  `- 💨 \`𝙹𝙰́ 𝚅𝙾𝙻𝚃𝙾\`

> *『 𝙿𝚁𝙾𝙲𝙴𝚂𝚂𝙰𝙽𝙳𝙾 』— ɴᴀ̃ᴏ sᴀɪ́ ᴅᴏ ᴄʜᴀᴛ ɴᴀ̃ᴏ, ᴏ sᴇᴜ ᴘᴇᴅɪᴅᴏ ᴊᴀ́ ᴠᴇᴍ. 👀*`,

  `- 🛠️ \`𝚃𝚁𝙰𝙱𝙰𝙻𝙷𝙰𝙽𝙳𝙾 𝙽𝙸𝚂𝚂𝙾\`

> *『 𝙰𝙶𝚄𝙰𝚁𝙳𝙴 』— ᴛᴏ̂ ᴀǫᴜɪ ɴᴏs ʙᴀsᴛɪᴅᴏʀᴇs ғᴀᴢᴇɴᴅᴏ ᴀ ᴍᴀ́ɢɪᴄᴀ. ✨*`,

  `- 🧠 \`𝙲𝙰𝙻𝙲𝚄𝙻𝙰𝙽𝙳𝙾...\`

> *『 𝙿𝚁𝙾𝙲𝙴𝚂𝚂𝙰𝙽𝙳𝙾 』— ᴅᴇɪxᴀ ᴇᴜ ᴜsᴀʀ ᴍᴇᴜs 2 ɴᴇᴜʀᴏ̂ɴɪᴏs ᴀǫᴜɪ. 🤣*`,

  `- 🤖 \`𝙱𝙾𝚃 𝙴𝙼 𝙰𝙲̧𝙰̃𝙾\`

> *『 𝙰𝙶𝚄𝙰𝚁𝙳𝙴 』— ᴏ ʀᴏʙᴏ̂ ᴛᴀ́ ᴛʀᴀʙᴀʟʜᴀɴᴅᴏ, ɴᴀ̃ᴏ ᴅᴇsʟɪɢᴀ ᴇʟᴇ ᴀɢᴏʀᴀ. 😂*`,

  `- ❤️ \`𝙼𝙾𝙳𝙾 𝙽𝙰𝙼𝙾𝚁𝙾\`

> *『 𝙰𝙶𝚄𝙰𝚁𝙳𝙴 』— ᴏ sᴇᴜ ᴘᴇᴅɪᴅᴏ ᴛᴀ́ ᴅᴇᴍᴏʀᴀɴᴅᴏ ᴍᴀɪs ǫᴜᴇ ᴠᴏᴄᴇ̂ ᴘʀᴀ ᴘᴇᴅɪʀ ᴀǫᴜᴇʟᴀ ᴘᴇssᴏᴀ ᴇᴍ ɴᴀᴍᴏʀᴏ. 😂❤️*`,

  `- 💍 \`𝙰𝙶𝚄𝙰𝚁𝙳𝙴...\`

> *『 𝙽𝙰𝙼𝙾𝚁𝙾 』— ᴇɴǫᴜᴀɴᴛᴏ ᴇᴜ ᴘʀᴏᴄᴇssᴏ ɪssᴏ, ᴊᴀ́ ᴠᴀɪ ᴇsᴄᴏʟʜᴇɴᴅᴏ ᴀ ᴀʟɪᴀɴᴄ̧ᴀ. 💍😂*`,

  `- 💕 \`𝙲𝙰𝙻𝙼𝙰 𝙲𝙾𝚁𝙰𝙲̧𝙰̃𝙾\`

> *『 𝙿𝚁𝙾𝙲𝙴𝚂𝚂𝙰𝙽𝙳𝙾 』— ᴇᴜ sᴇɪ ǫᴜᴇ ᴠᴏᴄᴇ̂ ᴛᴀ́ ᴀɴsɪᴏsᴏ, ᴍᴀs ɴᴀ̃ᴏ ᴇ́ ᴜᴍ ᴘᴇᴅɪᴅᴏ ᴅᴇ ɴᴀᴍᴏʀᴏ ɴᴀ̃ᴏ. 😂*`,

  `- 🥰 \`𝚄𝙼 𝙿𝙾𝚄𝚀𝚄𝙸𝙽𝙷𝙾...\`

> *『 𝙰𝙼𝙾𝚁 』— sᴇ ᴀɴsɪᴇᴅᴀᴅᴇ ғᴏssᴇ ᴀᴍᴏʀ, ᴠᴏᴄᴇ̂ ᴊᴀ́ ᴛᴀᴠᴀ ᴄᴀsᴀᴅᴏ. 🤣❤️*`,

  `- 😏 \`𝙴𝚂𝙿𝙴𝚁𝙰 𝙰𝙸́...\`

> *『 𝙽𝙰𝙼𝙾𝚁𝙾 』— ᴠᴏᴄᴇ̂ ᴘᴏᴅᴇ ᴀᴛᴇ́ ᴇsᴛᴀʀ sᴏʟᴛᴇɪʀᴏ, ᴍᴀs sᴇᴜ ᴘᴇᴅɪᴅᴏ ɴᴀ̃ᴏ ᴠᴀɪ ғɪᴄᴀʀ sᴏᴢɪɴʜᴏ. 😏*`,

  `- 😂 \`𝙼𝙾𝙳𝙾 𝙿𝙸𝙰𝙳𝙰\`

> *『 𝙿𝚁𝙾𝙲𝙴𝚂𝚂𝙰𝙽𝙳𝙾 』— ᴄᴀʟᴍᴀ, ᴏ sᴇʀᴠɪᴅᴏʀ ɴᴀ̃ᴏ ᴍᴏʀʀᴇᴜ... ᴇʟᴇ sᴏ́ ᴛᴀ́ ᴛɪʀᴀɴᴅᴏ ᴜᴍ ᴄᴏᴄʜɪʟᴏ. 🤣*`,

  `- 🤣 \`𝙰𝙶𝚄𝙰𝚁𝙳𝙴\`

> *『 𝙿𝙸𝙰𝙳𝙰 』— sᴇ ᴅᴇᴍᴏʀᴀʀ ᴅᴇᴍᴀɪs, ᴘᴏᴅᴇ ᴄᴜʟᴘᴀʀ ᴀ ɪɴᴛᴇʀɴᴇᴛ ᴅᴏ ᴠɪᴢɪɴʜᴏ. 😂*`,

  `- 🐌 \`𝚅𝙰𝙸 𝚂𝙰𝙸𝚁...\`

> *『 𝙲𝙰𝙻𝙼𝙰 』— ᴏ ᴘᴇᴅɪᴅᴏ ᴛᴀ́ ᴠɪɴᴅᴏ ᴅᴇ ᴜʙᴇʀ ᴄᴏᴍ ᴏ ᴍᴏᴛᴏʀɪsᴛᴀ ᴀ ᴘᴇ́. 🤣*`,

  `- 🗿 \`𝙲𝙰𝙻𝙼𝙰 𝙰𝙸́\`

> *『 𝙰𝙶𝚄𝙰𝚁𝙳𝙴 』— ᴇᴜ ɴᴀ̃ᴏ sᴏᴜ ᴜᴍᴀ ᴄᴀʟᴄᴜʟᴀᴅᴏʀᴀ ᴄᴀsɪᴏ ɴᴀ̃ᴏ, ᴄʜᴇғᴇ. 😂*`,

  `- ☕ \`𝙿𝚁𝙾𝙲𝙴𝚂𝚂𝙰𝙽𝙳𝙾\`

> *『 𝙲𝙰𝙵𝙴́ 』— ᴏ ʙᴏᴛ ᴛᴀ́ ᴛᴏᴍᴀɴᴅᴏ ᴜᴍ ᴄᴀғᴇᴢɪɴʜᴏ ᴘʀᴀ ᴛᴇʀᴍɪɴᴀʀ sᴇᴜ ᴘᴇᴅɪᴅᴏ. ☕😂*`,

  `- 😴 \`𝙿𝙴𝚁𝙰 𝙰𝙸́...\`

> *『 𝙲𝙰𝙻𝙼𝙰 』— ᴇᴜ ᴊᴜʀᴏ ǫᴜᴇ ɴᴀ̃ᴏ ᴅᴏʀᴍɪ, sᴏ́ ᴛᴀᴠᴀ ᴄᴏᴍ ᴏs ᴏʟʜᴏs ғᴇᴄʜᴀᴅᴏs. 🤣*`,

  `- 😎 \`𝙴𝙼 𝙱𝚁𝙴𝚅𝙴\`

> *『 𝙴𝙽𝚅𝙸𝙾 』— ᴏ ʙᴀɢᴜʟʜᴏ ᴛᴀ́ sᴇɴᴅᴏ, ᴄᴏɴғɪᴀ ɴᴏ ᴘᴀɪ. 😎*`,

  `- 💌 \`𝙲𝙰𝙽𝚃𝙰𝙳𝙰 𝙳𝙾 𝙱𝙾𝚃\`

> *『 𝙰𝙶𝚄𝙰𝚁𝙳𝙴 』— ᴠᴏᴄᴇ̂ ɴᴀ̃ᴏ ᴇ́ ᴡɪ-ғɪ, ᴍᴀs ᴇᴜ ᴊᴀ́ sᴇɴᴛɪ ᴜᴍᴀ ᴄᴏɴᴇxᴀ̃ᴏ ᴀǫᴜɪ. 😏❤️*`,

  `- 😏 \`𝙲𝙰𝙽𝚃𝙰𝙳𝙰\`

> *『 𝙿𝚁𝙾𝙲𝙴𝚂𝚂𝙰𝙽𝙳𝙾 』— ᴠᴏᴄᴇ̂ ᴇ́ ᴜᴍ ᴄᴏᴍᴀɴᴅᴏ? ᴘᴏʀǫᴜᴇ ᴇᴜ ᴛᴏ̂ ǫᴜᴇʀᴇɴᴅᴏ ᴛᴇ ᴇxᴇᴄᴜᴛᴀʀ... ᴏᴘᴀ. 😂*`,

  `- ❤️‍🔥 \`𝙲𝙰𝙻𝙼𝙰...\`

> *『 𝙲𝙰𝙽𝚃𝙰𝙳𝙰 』— ᴇᴜ ɴᴀ̃ᴏ sᴏᴜ ɢᴏᴏɢʟᴇ, ᴍᴀs ᴠᴏᴄᴇ̂ ᴛᴇᴍ ᴛᴜᴅᴏ ǫᴜᴇ ᴇᴜ ᴘʀᴏᴄᴜʀᴏ. 😏*`,

  `- 🌹 \`𝙿𝙴𝚁𝙰 𝙰𝙸́\`

> *『 𝙲𝙰𝙽𝚃𝙰𝙳𝙰 』— sᴇ ʙᴇʟᴇᴢᴀ ᴅᴇssᴇ ʙᴀɴ, ᴠᴏᴄᴇ̂ ᴊᴀ́ ᴛᴀᴠᴀ ᴇᴍ ʙᴀɴɢᴘ. 😂🌹*`,

  `- 💘 \`𝙿𝚁𝙾𝙲𝙴𝚂𝚂𝙰𝙽𝙳𝙾\`

> *『 𝙲𝙰𝙽𝚃𝙰𝙳𝙰 』— ᴠᴏᴄᴇ̂ ᴇ́ ᴀᴘɪᴋᴇʏ? ᴘᴏʀǫᴜᴇ sᴇᴍ ᴠᴏᴄᴇ̂ ᴇᴜ ɴᴀ̃ᴏ ғᴜɴᴄɪᴏɴᴏ. 😭❤️*`,

  `- 🫶 \`𝙰𝙶𝚄𝙰𝚁𝙳𝙴\`

> *『 𝙲𝙰𝙽𝚃𝙰𝙳𝙰 』— ᴠᴏᴄᴇ̂ ᴇ́ ᴏ ᴘʀᴇғɪxᴏ ᴅᴏ ᴍᴇᴜ ʙᴏᴛ? ᴘᴏʀǫᴜᴇ sᴇᴍ ᴠᴏᴄᴇ̂ ᴇᴜ ɴᴇᴍ sᴇɪ ᴄᴏᴍᴏ ᴄᴏᴍᴇᴄ̧ᴀʀ. 😂❤️*`,

  `- 📡 \`𝙲𝙾𝙽𝙴𝙲𝚃𝙰𝙽𝙳𝙾...\`

> *『 𝙴𝙽𝚅𝙸𝙾 』— ᴛᴏ̂ ʙᴜsᴄᴀɴᴅᴏ ᴛᴜᴅᴏ ᴘʀᴀ ᴠᴏᴄᴇ̂, sᴏ́ ᴍᴀɪs ᴜᴍ ᴘᴏᴜǫᴜɪɴʜᴏ. 📡*`,

  `- 🔍 \`𝙱𝚄𝚂𝙲𝙰𝙽𝙳𝙾...\`

> *『 𝙿𝙴𝚂𝚀𝚄𝙸𝚂𝙰𝙽𝙳𝙾 』— ᴇᴜ ᴛᴏ̂ ᴘʀᴏᴄᴜʀᴀɴᴅᴏ ᴏ ǫᴜᴇ ᴠᴏᴄᴇ̂ ᴘᴇᴅɪᴜ. 🔎*`,

  `- 🎵 \`𝙿𝚁𝙴𝙿𝙰𝚁𝙰𝙽𝙳𝙾...\`

> *『 𝙼𝙸́𝙳𝙸𝙰 』— ᴊᴀ́ ᴇsᴛᴏᴜ ᴘʀᴇᴘᴀʀᴀɴᴅᴏ ᴀ sᴜᴀ ᴍɪ́ᴅɪᴀ. 🎧*`,

  `- 🎬 \`𝙲𝙰𝚁𝚁𝙴𝙶𝙰𝙽𝙳𝙾\`

> *『 𝚅𝙸́𝙳𝙴𝙾 』— ᴀɢᴜᴀʀᴅᴇ ᴜᴍ ᴘᴏᴜᴄᴏ ᴇɴǫᴜᴀɴᴛᴏ ᴘʀᴇᴘᴀʀᴏ ᴏ sᴇᴜ ᴠɪ́ᴅᴇᴏ. 🎥*`,

  `- 🎧 \`𝙰𝚄́𝙳𝙸𝙾 𝙰 𝙲𝙰𝙼𝙸𝙽𝙷𝙾\`

> *『 𝙴𝙽𝚅𝙸𝙰𝙽𝙳𝙾 』— ᴄᴏʟᴏᴄᴀ ᴏ ғᴏɴᴇ ᴀɪ́ ǫᴜᴇ ᴊᴀ́ ᴠᴇᴍ ʙᴀʀᴜʟʜᴏ. 😂🎧*`,

  `- 🖼️ \`𝙿𝚁𝙴𝙿𝙰𝚁𝙰𝙽𝙳𝙾 𝙸𝙼𝙰𝙶𝙴𝙼\`

> *『 𝙰𝙶𝚄𝙰𝚁𝙳𝙴 』— ᴛᴏ̂ ᴅᴀɴᴅᴏ ᴜᴍ ᴛᴀᴘᴀ ɴᴀ ǫᴜᴀʟɪᴅᴀᴅᴇ ᴀǫᴜɪ. 😂*`,

  `- 💾 \`𝙲𝙰𝚁𝚁𝙴𝙶𝙰𝙽𝙳𝙾...\`

> *『 𝙰𝚁𝚀𝚄𝙸𝚅𝙾 』— ᴇsᴛᴏᴜ ᴘʀᴇᴘᴀʀᴀɴᴅᴏ ᴏ ᴀʀǫᴜɪᴠᴏ ᴘᴀʀᴀ ᴏ ᴇɴᴠɪᴏ. 📁*`,

  `- 📥 \`𝙱𝙰𝙸𝚇𝙰𝙽𝙳𝙾...\`

> *『 𝙳𝙾𝚆𝙽𝙻𝙾𝙰𝙳 』— ᴏ ᴄᴏɴᴛᴇᴜ́ᴅᴏ ᴊᴀ́ ᴇsᴛᴀ́ sᴇɴᴅᴏ ʙᴀɪxᴀᴅᴏ. 📥*`,

  `- 📤 \`𝙵𝙰𝚂𝙴 𝙵𝙸𝙽𝙰𝙻\`

> *『 𝙴𝙽𝚅𝙸𝙾 』— ᴀɢᴏʀᴀ sᴏ́ ғᴀʟᴛᴀ ᴇɴᴠɪᴀʀ ᴘʀᴀ ᴠᴏᴄᴇ̂. 😎*`,

  `- 🏃 \`𝙲𝙾𝚁𝚁𝙴𝙽𝙳𝙾 𝙰𝚀𝚄𝙸...\`

> *『 𝙰𝙶𝚄𝙰𝚁𝙳𝙴 』— ᴇᴜ ᴛᴏ̂ ᴄᴏʀʀᴇɴᴅᴏ ᴘʀᴀ ɴᴀ̃ᴏ ᴛᴏᴍᴀʀ ᴜᴍ “ʙᴏᴛ ʟᴇɴᴛᴏ”. 😂*`,

  `- 🫠 \`𝙽𝙰̃𝙾 𝙳𝙴𝚂𝙸𝚂𝚃𝙴 𝙳𝙴 𝙼𝙸𝙼\`

> *『 𝙰𝙶𝚄𝙰𝚁𝙳𝙴 』— ᴇᴜ ᴇsᴛᴏᴜ ᴛᴇɴᴛᴀɴᴅᴏ, ᴊᴜʀᴏ. 🥲😂*`,

  `- 👀 \`𝙾𝙻𝙷𝙰 𝙰𝙸́...\`

> *『 𝙿𝚁𝙾𝙲𝙴𝚂𝚂𝙰𝙽𝙳𝙾 』— ɴᴀ̃ᴏ ᴘʀᴇᴄɪsᴀ ғɪᴄᴀʀ ᴏʟʜᴀɴᴅᴏ ᴘʀᴀ ᴀ ᴛᴇʟᴀ, ᴇᴜ ɴᴀ̃ᴏ ᴠᴏᴜ ғᴜɢɪʀ. 😂*`,

  `- 🔥 \`𝚃𝙰́ 𝚂𝙰𝙸𝙽𝙳𝙾\`

> *『 𝙰𝙶𝚄𝙰𝚁𝙳𝙴 』— ᴇssᴇ ᴘᴇᴅɪᴅᴏ ᴛᴀ́ ǫᴜᴇɴᴛᴇ, ᴊᴀ́ ᴊᴀ́ ᴛᴀ́ ɴᴀ sᴜᴀ ᴛᴇʟᴀ. 🔥*`,

  `- 🧑‍🍳 \`𝙲𝙾𝚉𝙸𝙽𝙷𝙰𝙽𝙳𝙾...\`

> *『 𝙿𝚁𝙾𝙲𝙴𝚂𝚂𝙰𝙽𝙳𝙾 』— ᴛᴏ̂ ᴄᴏᴢɪɴʜᴀɴᴅᴏ sᴇᴜ ᴘᴇᴅɪᴅᴏ. ᴇsᴘᴇʀᴀ ɴᴀ̃ᴏ ǫᴜᴇɪᴍᴀʀ. 😂*`,

  `- 🧊 \`𝙲𝙰𝙻𝙼𝙰 𝙰𝙸́\`

> *『 𝙰𝙶𝚄𝙰𝚁𝙳𝙴 』— ғɪᴄᴀ ғʀɪᴏ ᴀɪ́, ᴊᴀ́ ᴇsᴛᴏᴜ ғɪɴᴀʟɪᴢᴀɴᴅᴏ. 🧊*`,

  `- 🛰️ \`𝙱𝚄𝚂𝙲𝙰𝙽𝙳𝙾 𝚂𝙸𝙽𝙰𝙻\`

> *『 𝙲𝙾𝙽𝙴𝙲𝚃𝙰𝙽𝙳𝙾 』— ᴏ sᴀᴛᴇ́ʟɪᴛᴇ ᴊᴀ́ ʀᴇᴄᴇʙᴇᴜ ᴏ ᴘᴇᴅɪᴅᴏ. 😂🛰️*`,

  `- 🫡 \`𝙾𝚁𝙳𝙴𝙼 𝚁𝙴𝙲𝙴𝙱𝙸𝙳𝙰\`

> *『 𝙿𝚁𝙾𝙲𝙴𝚂𝚂𝙰𝙽𝙳𝙾 』— sɪᴍ sᴇɴʜᴏʀ, ᴊᴀ́ ᴇsᴛᴏᴜ ᴄᴜᴍᴘʀɪɴᴅᴏ ᴀ ᴍɪssᴀ̃ᴏ. 🫡*`,

  `- 💻 \`𝙱𝙾𝚃 𝚃𝚁𝙰𝙱𝙰𝙻𝙷𝙰𝙽𝙳𝙾\`

> *『 𝙰𝙶𝚄𝙰𝚁𝙳𝙴 』— ᴇᴜ ᴛᴏ̂ ǫᴜᴀsᴇ ᴘᴇᴅɪɴᴅᴏ ʜᴏʀᴀ ᴇxᴛʀᴀ ᴀǫᴜɪ. 😂*`,

  `- 🥹 \`𝙰𝙶𝚄𝙰𝚁𝙳𝙰 𝙴𝚄...\`

> *『 𝙲𝙰𝙻𝙼𝙰 』— sᴇ ᴠᴏᴄᴇ̂ ᴄᴀɴᴄᴇʟᴀʀ ᴀɢᴏʀᴀ ᴇᴜ ᴠᴏᴜ ғɪᴄᴀʀ ᴛʀɪsᴛᴇ. 😭😂*`,

  `- 💞 \`𝙰𝙼𝙾𝚁 𝙴𝙼 𝙿𝚁𝙾𝙲𝙴𝚂𝚂𝙾\`

> *『 𝙽𝙰𝙼𝙾𝚁𝙾 』— ᴀɢᴜᴀʀᴅᴀ ᴀɪ́, ᴘᴏʀǫᴜᴇ ᴅɪғᴇʀᴇɴᴛᴇ ᴅᴏ sᴇᴜ ᴄʀᴜsʜ, ᴇᴜ ᴠᴏᴜ ᴛᴇ ʀᴇsᴘᴏɴᴅᴇʀ. 😂❤️*`,

  `- 💔 \`𝙲𝙰𝙻𝙼𝙰...\`

> *『 𝙽𝙰𝙼𝙾𝚁𝙾 』— ᴏ sᴇᴜ ᴘᴇᴅɪᴅᴏ ɴᴀ̃ᴏ ᴛᴇ ᴅᴇɪxᴏᴜ ɴᴏ ᴠɪsᴛᴏ, ᴇʟᴇ sᴏ́ ᴛᴀ́ ᴘʀᴏᴄᴇssᴀɴᴅᴏ. 😂*`,

  `- 😳 \`𝙲𝙰𝙽𝚃𝙰𝙳𝙰 𝙰𝙻𝙴𝙰𝚃𝙾́𝚁𝙸𝙰\`

> *『 𝙰𝙶𝚄𝙰𝚁𝙳𝙴 』— ᴠᴏᴄᴇ̂ ᴇ́ ᴜᴍ ʙᴜɢ? ᴘᴏʀǫᴜᴇ ᴅᴇsᴅᴇ ǫᴜᴇ ᴇᴜ ᴛᴇ ᴠɪ ᴍᴇᴜ sɪsᴛᴇᴍᴀ ᴘᴀʀᴏᴜ. 😳❤️*`,

  `- 🤭 \`𝙲𝙰𝙽𝚃𝙰𝙳𝙰\`

> *『 𝙿𝚁𝙾𝙲𝙴𝚂𝚂𝙰𝙽𝙳𝙾 』— ᴠᴏᴄᴇ̂ ᴅᴇᴠᴇ sᴇʀ ᴜᴍ ᴜᴘᴅᴀᴛᴇ, ᴘᴏʀǫᴜᴇ ᴅᴇᴘᴏɪs ǫᴜᴇ ᴠᴏᴄᴇ̂ ᴀᴘᴀʀᴇᴄᴇᴜ ᴛᴜᴅᴏ ғɪᴄᴏᴜ ᴍᴇʟʜᴏʀ. 😏*`,

  `- 👑 \`𝙰𝙶𝚄𝙰𝚁𝙳𝙴 𝙰𝙸́\`

> *『 𝙴𝙽𝚅𝙸𝙾 』— ᴘᴇᴅɪᴅᴏ ᴅᴇ ʀᴇɪ ᴍᴇʀᴇᴄᴇ ᴄᴀᴘʀɪᴄʜᴏ. 👑*`,

  `- ✅ \`𝚀𝚄𝙰𝚂𝙴 𝙿𝚁𝙾𝙽𝚃𝙾\`

> *『 𝙵𝙸𝙽𝙰𝙻𝙸𝚉𝙰𝙽𝙳𝙾 』— ғᴀʟᴛᴀ ᴘᴏᴜᴄᴏ, ᴏ sᴇᴜ ᴘᴇᴅɪᴅᴏ ᴊᴀ́ ᴠᴀɪ sᴇʀ ᴇɴᴠɪᴀᴅᴏ. ✅*`
]
...
> *『 ${prefix}fechargp 22:00 』— ᴜsᴇ ᴇssᴇ ғᴏʀᴍᴀᴛᴏ ᴘᴀʀᴀ ᴘʀᴏɢʀᴀᴍᴀʀ ᴏ ғᴇᴄʜᴀᴍᴇɴᴛᴏ ᴅᴏ ɢʀᴜᴘᴏ. ᴠᴏᴄᴇ̂ ᴛᴀᴍʙᴇ́ᴍ ᴘᴏᴅᴇ ᴍᴀʀᴄᴀʀ ᴜᴍᴀ ɪᴍᴀɢᴇᴍ, ᴠɪ́ᴅᴇᴏ, ᴀ́ᴜᴅɪᴏ ᴏᴜ ғɪɢᴜʀɪɴʜᴀ. 🙇‍♂️*`
}
...
> *『 ${prefix}abrirgp 07:00 』— ᴜsᴇ ᴇssᴇ ғᴏʀᴍᴀᴛᴏ ᴘᴀʀᴀ ᴘʀᴏɢʀᴀᴍᴀʀ ᴀ ᴀʙᴇʀᴛᴜʀᴀ ᴅᴏ ɢʀᴜᴘᴏ. ᴠᴏᴄᴇ̂ ᴛᴀᴍʙᴇ́ᴍ ᴘᴏᴅᴇ ᴍᴀʀᴄᴀʀ ᴜᴍᴀ ɪᴍᴀɢᴇᴍ, ᴠɪ́ᴅᴇᴏ, ᴀ́ᴜᴅɪᴏ ᴏᴜ ғɪɢᴜʀɪɴʜᴀ. 🙇‍♂️*`
}
...
? lista.map((item, indice) => `> *『 ${indice + 1} 』— ${item}*`).join('\n')
: linhaPadrao('0', vazio)
...
> *『 𝙴𝚂𝙿𝙾𝙽𝚃𝙰̂𝙽𝙴𝙾 』— ${prefix}modoia espontaneo 1/0*`
}
...
> *『 ✅ 𝚂𝚃𝙰𝚃𝚄𝚂 』— Entrei no grupo com sucesso.*
> *『 🏷️ 𝙽𝙾𝙼𝙴 』— ${nome || 'Grupo'}*
> *『 👤 𝙼𝙴𝙼𝙱𝚁𝙾𝚂 』— ${Number(quantidade || 0)}*
> *『 🔗 𝙻𝙸𝙽𝙺 』— ${link || 'Não informado'}*
${id ? `> *『 🆔 𝙶𝚁𝚄𝙿𝙾 』— ${id}*\n` : ''}> *『 💾 𝚂𝙰𝚅𝙴𝙶𝙿 』— Grupo salvo automaticamente no sistema de aluguel.*`
}

exports.aluguelSaveGp = ({ nome = 'Grupo', quantidade = 0, id = '', link = '' } = {}) => {
return `- 💾 \`𝚂𝙰𝚅𝙴𝙶𝙿\`

> *『 ✅ 𝚂𝚃𝙰𝚃𝚄𝚂 』— Grupo registrado no sistema de aluguel.*
> *『 🏷️ 𝙽𝙾𝙼𝙴 』— ${nome || 'Grupo'}*
> *『 👤 𝙼𝙴𝙼𝙱𝚁𝙾𝚂 』— ${Number(quantidade || 0)}*
${id ? `> *『 🆔 𝙶𝚁𝚄𝙿𝙾 』— ${id}*\n` : ''}${link ? `> *『 🔗 𝙻𝙸𝙽𝙺 』— ${link}*\n` : ''}> *『 ♾️ 𝚅𝙴𝙽𝙲𝙸𝙼𝙴𝙽𝚃𝙾 』— Sem vencimento (SaveGP). *`
}
...
> *『 ✅ 𝙿𝙰𝙶𝙰𝙼𝙴𝙽𝚃𝙾 』— ᴏ sᴇᴜ ᴘᴀɢᴀᴍᴇɴᴛᴏ ᴊᴀ́ ғᴏɪ ᴀᴘʀᴏᴠᴀᴅᴏ.*

> *『 👥 𝙶𝚁𝚄𝙿𝙾 』— ᴀɢᴜᴀʀᴅᴀɴᴅᴏ ᴀ ᴇɴᴛʀᴀᴅᴀ ᴅᴏ ʙᴏᴛ ɴᴏ ɢʀᴜᴘᴏ ᴘᴀʀᴀ ᴀᴛɪᴠᴀʀ ᴏ ᴀʟᴜɢᴜᴇʟ.*`
}

exports.aluguelLinkInvalido = () => {
return `- ❌ \`𝙻𝙸𝙽𝙺 𝙸𝙽𝚅𝙰́𝙻𝙸𝙳𝙾\`

> *『 🔗 𝙶𝚁𝚄𝙿𝙾 』— ɴᴀ̃ᴏ ғᴏɪ ᴘᴏssɪ́ᴠᴇʟ ᴀᴄᴇssᴀʀ ᴏ ʟɪɴᴋ ᴅᴏ ɢʀᴜᴘᴏ. ᴠᴇʀɪғɪǫᴜᴇ sᴇ ᴏ ʟɪɴᴋ ᴇ́ ᴠᴀ́ʟɪᴅᴏ.*`
}

exports.aluguelGrupoNaoIdentificado = () => {
return `- ⚠️ \`𝙶𝚁𝚄𝙿𝙾 𝙽𝙰̃𝙾 𝙸𝙳𝙴𝙽𝚃𝙸𝙵𝙸𝙲𝙰𝙳𝙾\`

> *『 👥 𝙶𝚁𝚄𝙿𝙾 』— ᴏ ᴘᴀɢᴀᴍᴇɴᴛᴏ ғᴏɪ ᴀᴘʀᴏᴠᴀᴅᴏ, ᴍᴀs ᴀɪɴᴅᴀ ɴᴀ̃ᴏ ғᴏɪ ᴘᴏssɪ́ᴠᴇʟ ᴄᴏɴғɪʀᴍᴀʀ ᴀ ᴇɴᴛʀᴀᴅᴀ ᴅᴏ ʙᴏᴛ.*`
}

exports.aluguelSolicitacaoEnviada = nome => {
return `- 📥 \`𝚂𝙾𝙻𝙸𝙲𝙸𝚃𝙰𝙲̧𝙰̃𝙾 𝙴𝙽𝚅𝙸𝙰𝙳𝙰\`

> *『 👥 ${nome || '𝙶𝚁𝚄𝙿𝙾'} 』— ᴏ ᴘᴀɢᴀᴍᴇɴᴛᴏ ғᴏɪ ᴀᴘʀᴏᴠᴀᴅᴏ.*

> *『 ⏳ 𝚂𝚃𝙰𝚃𝚄𝚂 』— ᴀ sᴏʟɪᴄɪᴛᴀᴄ̧ᴀ̃ᴏ ᴅᴇ ᴇɴᴛʀᴀᴅᴀ ғᴏɪ ᴇɴᴠɪᴀᴅᴀ. ᴏ ᴀʟᴜɢᴜᴇʟ sᴇʀᴀ́ ᴀᴛɪᴠᴀᴅᴏ ᴀssɪᴍ ǫᴜᴇ ᴏ ʙᴏᴛ ᴇɴᴛʀᴀʀ ɴᴏ ɢʀᴜᴘᴏ.*`
}
...
> *『 ⏳ 𝙳𝚄𝚁𝙰𝙲̧𝙰̃𝙾 』— ${g.duracaoDias || 0} dias*
> *『 📅 𝚅𝙴𝙽𝙲𝙸𝙼𝙴𝙽𝚃𝙾 』— ${fim}*
> *『 👤 𝙲𝙾𝙼𝙿𝚁𝙰𝙳𝙾𝚁 』— @${String(comprador || '').split('@')[0]}*

> *『 🧊 𝚂𝚃𝙰𝚃𝚄𝚂 』— ᴏ ʙᴏᴛ ᴇɴᴛʀᴏᴜ ɴᴏ ɢʀᴜᴘᴏ ᴇ ᴏ ᴀʟᴜɢᴜᴇʟ ғᴏɪ ʀᴇɢɪsᴛʀᴀᴅᴏ ᴄᴏᴍ sᴜᴄᴇssᴏ.*`
}
...
> *『 📦 𝙿𝙻𝙰𝙽𝙾 』— ${g.planoNome || 'Plano'}*
${g.grupoNome ? `> *『 🏷️ 𝙶𝚁𝚄𝙿𝙾 』— ${g.grupoNome}*\n` : ''}${g.quantidadeMembros ? `> *『 👤 𝙼𝙴𝙼𝙱𝚁𝙾𝚂 』— ${g.quantidadeMembros}*\n` : ''}> *『 📅 𝚅𝙴𝙽𝙲𝙴 』— ${vencimento}*
> *『 ⏳ 𝚁𝙴𝚂𝚃𝙰 』— ${resta}*`
}
...
> *『 ${atualizacaoCompleta ? 'COMPLETA' : totalArquivos} 』— ${atualizacaoCompleta ? 'ɴᴏᴠᴀ ᴇsᴛʀᴜᴛᴜʀᴀ ᴏғɪᴄɪᴀʟ ᴅᴀ ᴛᴏᴋɪᴛᴏ.' : 'ᴀʀǫᴜɪᴠᴏ(s) ᴀʟᴛᴇʀᴀᴅᴏ(s).'}*
...
> *『 📌 𝚄𝚂𝙾 』— ${prefix}toimg respondendo uma figurinha*
> *『 🖼️ 𝙵𝚄𝙽𝙲̧𝙰̃𝙾 』— Converte a figurinha para imagem PNG.*`
}

exports.toimgErro = () => {
return `- ❌ \`𝙴𝚁𝚁𝙾 𝙽𝙾 𝚃𝙾𝙸𝙼𝙶\`

> *『 ⚠️ 𝙴𝚁𝚁𝙾 』— Não foi possível converter a figurinha em imagem.*
...
> *『 📌 𝚄𝚂𝙾 』— ${prefix}togif respondendo uma figurinha animada*
> *『 🎬 𝙵𝚄𝙽𝙲̧𝙰̃𝙾 』— Converte a figurinha animada para vídeo/GIF.*`
}

exports.togifNaoAnimada = prefix => {
return `- ⚠️ \`𝙵𝙸𝙶𝚄𝚁𝙸𝙽𝙷𝙰 𝙽𝙰̃𝙾 𝙰𝙽𝙸𝙼𝙰𝙳𝙰\`

> *『 🎞️ 𝚃𝙾𝙶𝙸𝙵 』— Esse comando precisa de uma figurinha animada.*
> *『 🖼️ 𝙳𝙸𝙲𝙰 』— Para figurinha estática, use ${prefix}toimg.*`
}
...
> *『 📌 𝚄𝚂𝙾 』— responda um áudio e use ${prefix}shazam.*
> *『 🎵 𝙵𝚄𝙽𝙲̧𝙰̃𝙾 』— identifica a música, mostra os dados e tenta enviar o áudio completo.*`
}

exports.shazamAnalisando = () => {
return `- 🎛️ \`𝚂𝙷𝙰𝚉𝙰𝙼\`

> *『 🔎 𝙰𝙽𝙰𝙻𝙸𝚂𝙰𝙽𝙳𝙾 』— estou ouvindo o áudio e tentando identificar a música. 🎧*`
}

exports.shazamNaoEncontrada = () => {
return `- ❌ \`𝚂𝙷𝙰𝚉𝙰𝙼\`

> *『 🎵 𝙽𝙰̃𝙾 𝙸𝙳𝙴𝙽𝚃𝙸𝙵𝙸𝙲𝙰𝙳𝙰 』— não consegui reconhecer essa música.*
> *『 💡 𝙳𝙸𝙲𝙰 』— tente um trecho com a música mais alta e menos conversa ou ruído.*`
}

exports.shazamArquivoGrande = () => {
return `- ⚠️ \`𝚂𝙷𝙰𝚉𝙰𝙼\`

> *『 📦 𝙰𝚁𝚀𝚄𝙸𝚅𝙾 𝙼𝚄𝙸𝚃𝙾 𝙶𝚁𝙰𝙽𝙳𝙴 』— o áudio ultrapassa 10 MB.*
> *『 ✂️ 𝙳𝙸𝙲𝙰 』— envie um trecho menor da música e tente novamente.*`
}

exports.shazamLimite = () => {
return `- ⏳ \`𝚂𝙷𝙰𝚉𝙰𝙼\`

> *『 🚦 𝙻𝙸𝙼𝙸𝚃𝙴 𝚃𝙴𝙼𝙿𝙾𝚁𝙰́𝚁𝙸𝙾 』— o identificador recebeu muitas consultas agora.*
> *『 🔄 𝚃𝙴𝙽𝚃𝙴 𝙽𝙾𝚅𝙰𝙼𝙴𝙽𝚃𝙴 』— aguarde alguns segundos e repita o comando.*`
}

exports.shazamResultado = dados => {
const linhas = [
  `- 🎵 \`𝙼𝚄́𝚂𝙸𝙲𝙰 𝙸𝙳𝙴𝙽𝚃𝙸𝙵𝙸𝙲𝙰𝙳𝙰\``,
  '',
  `> *『 🎼 𝚃𝙸́𝚃𝚄𝙻𝙾 』— ${dados?.titulo || 'Não informado'}*`,
  `> *『 🎤 𝙰𝚁𝚃𝙸𝚂𝚃𝙰 』— ${dados?.artista || 'Não informado'}*`
]

if (dados?.album) linhas.push(`> *『 💿 𝙰́𝙻𝙱𝚄𝙼 』— ${dados.album}*`)
if (dados?.lancamento) linhas.push(`> *『 📅 𝙻𝙰𝙽𝙲̧𝙰𝙼𝙴𝙽𝚃𝙾 』— ${dados.lancamento}*`)
if (dados?.gravadora) linhas.push(`> *『 🏷️ 𝙶𝚁𝙰𝚅𝙰𝙳𝙾𝚁𝙰 』— ${dados.gravadora}*`)
if (dados?.score != null) linhas.push(`> *『 🎯 𝙲𝙾𝙽𝙵𝙸𝙰𝙽𝙲̧𝙰 』— ${Math.round(Number(dados.score) || 0)}%*`)
if (dados?.spotify) linhas.push(`> *『 🟢 𝚂𝙿𝙾𝚃𝙸𝙵𝚈 』— ${dados.spotify}*`)
if (dados?.appleMusic) linhas.push(`> *『 🍎 𝙰𝙿𝙿𝙻𝙴 𝙼𝚄𝚂𝙸𝙲 』— ${dados.appleMusic}*`)
if (dados?.link) linhas.push(`> *『 🔗 𝙻𝙸𝙽𝙺 』— ${dados.link}*`)

return linhas.join('\n')
}

exports.shazamAudioIndisponivel = () => {
return `- ⚠️ \`𝚂𝙷𝙰𝚉𝙰𝙼\`

> *『 🎧 𝙰́𝚄𝙳𝙸𝙾 』— a música foi identificada, mas não consegui enviar o MP3 agora.*`
}

exports.shazamErro = () => {
return `- ❌ \`𝙴𝚁𝚁𝙾 𝙽𝙾 𝚂𝙷𝙰𝚉𝙰𝙼\`

> *『 ⚠️ 𝙴𝚁𝚁𝙾 』— não foi possível concluir a identificação da música.*
> *『 🔄 𝚃𝙴𝙽𝚃𝙴 𝙽𝙾𝚅𝙰𝙼𝙴𝙽𝚃𝙴 』— responda um áudio e execute o comando novamente.*`
}
