...
exports.Sticker = class Sticker {
  ...
  async start() {
    ...
    if (!read.length)
      return Promise.reject('Não foi adicionado nenhum arquivo/buffer/url no cache.')
